export const COMPANY_SCHEMA_STATEMENTS = [
...
export const REGISTRY_SCHEMA_STATEMENTS = [
...
/** Columns to add on older company DBs created before GST. */
export const COMPANY_COLUMN_MIGRATIONS: { table: string; column: string; ddl: string }[] = [
  { table: "ledger", column: "state_code", ddl: "ALTER TABLE ledger ADD COLUMN state_code TEXT" },
  {
    table: "voucher",
  ...
  { table: "voucher", column: "hsn_sac", ddl: "ALTER TABLE voucher ADD COLUMN hsn_sac TEXT" },
  { table: "voucher", column: "gst_rate", ddl: "ALTER TABLE voucher ADD COLUMN gst_rate REAL" },
  {
    table: "voucher",
...
export const INTEGRATION_SCHEMA_STATEMENTS = [
...
export const REGISTRY_COLUMN_MIGRATIONS: { table: string; column: string; ddl: string }[] = [
  {
    table: "companies",
    column: "gst_enabled",
    ddl: "ALTER TABLE companies ADD COLUMN gst_enabled INTEGER NOT NULL DEFAULT 0",
  },
];
